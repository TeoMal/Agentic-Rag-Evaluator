...
When the team merges, these fields can move into hackathon2.config.Settings unchanged.
    ...
    AGENT_TOOL_SOURCE=mcp       the NFS MCP server, started per run over stdio (default)
    AGENT_TOOL_SOURCE=stub      stub tools (offline, invented test data)
"""
...
class AgentSettings(BaseSettings):
    ...
    tool_source: Literal["mcp", "stub"] = "mcp"
